...
def require_login():
    ...
    allowed_routes = ['login', 'signup', 'index', 'blog','user', 'static']
...
def index():
    ...
    return render_template('index.html', users=users, header='All Blog Users')
...
def signup():
    ...
    if request.method == 'POST':
        ...
        if password != verify:
            ...
            flash('Please enter username, password and verify','error')
